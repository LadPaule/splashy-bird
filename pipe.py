...
class Pipe(Widget):
    ...
    def on_size(self, *args):
        ...
        self.lower_pipe_tex_coords[5] = lower_body_size /  18.
        self.lower_pipe_tex_coords[7] = lower_body_size /  18.

        top_body_size = self.top - self.top_body_position
        self.top_pipe_tex_coords[5] = top_body_size /  18.
        self.top_pipe_tex_coords[7] = top_body_size /  18.